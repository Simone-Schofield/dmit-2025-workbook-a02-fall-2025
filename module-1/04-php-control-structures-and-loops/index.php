    ...
    <section class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <?php
              ...
              // We can also check to see if two values are NOT equal with negation operator.
              if ($x != 5) {
              ...
              // Let's try a comparsion operator! This is 'greater than'.
              if ($x > 5) {
            ...
            <?php
              ...
              //   $message = "<p>X is a number.</p>";
                ...
                $message = "<p>X is not a equal to 5, equal to 6, or a number.</p>";
              }} else {
                $message = "<p>X is not a number.</p>";
              }

              // echo $message; echo "<p></p>";
            ...
            <?php
              ...
              switch (TRUE) {
                ...
                case $x === 5:
                  $message = "<p>X is 5.</p>";
                  // If the condition is met, we need to 'break' in order to exit the structure. If we do not break, then we do no exit the switch statements when we should and we keep evaluating subsequent cases.
                  break;
            ...
            <?php
              ...
              /**
               * This is a match expression. it return a value, uses strict comparsions, and has concise syntax; however, it is functionally the same as our IF/ELSEIF/ELSE structures and switch statements.
               * 
               * Whatever you put in the parenthesis is the thing you're 'matching' against each arm. It could be a variable, the literal TRUE, or even a function call.
               * 
               * Each line inside of the curly braces is called an arm. An arm has two parts, separated by the arrow => :
               * 
            ...
            <?php
              ...
              /**
               * Loops need at least three things to work property (and not get stuck in an infinite loop):
               * 
               ...
               * 
               * 3. Some sort of change where the condition can appoarch FALSE; this is usually an increment (++) or a decrement (--).
               */
            ...
            <?php
              ...
              // This is a test-last (or post-test) loop. This means that if we check the condition last, the loop will execute at least once. 
            ...
            <?php
              ...
              // This is also a test-first (or pre-test) loop. All three of our requirements for a loop are declared on the first line.
