...
if ($rank == "" || $country =="") {
    ...
    /*
        ...
        Due to the way that SQL is structure, it's easy for users to slip in an arbitrary statement with their inputs (including query strings). This is why we need to use perpared statements and sanitise our values.
    ...
    */
    ...
    // This is a prepared statement. It's a template for a kind of query we're going to be using on this page. It uses a ? (a placeholder) value instead of the raw value (ex. $rank). This gives us an additional layer of security (via levels of abstraction) and makes us subtantially less vulnerable to attacks like SQL injections.
    ...
    if ($statement = $connection->prepare($query)) {
        // Next, we need to tell SQL what data type (interger, in this case) we are using and which parameter (value) to bind to our earlier 'template'.
