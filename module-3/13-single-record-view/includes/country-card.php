...
// Let's 'translate' the interger to the continent's actual name.
$continents = $continents_key[$row ['continent']];
...
<div class="card px-0">
    ...
    <div class="card-body">
        ...
        <!-- Population -->
        <p class="card-text"><span class="fw-bold">Population</span>: <?= number_format($row['population']); ?></p>

        <!-- Life Expectancy -->
        <p class="card-text"><span class="fw-bold">Life Expectancy</span>: <?= $row['life_expectancy'] . " years"; ?></p>
        ...
        <!-- GDP (per Capita) -->
        <p class="card-text"><span class="fw-bold">Gross Domestic Product (per Capita)</span>: <?= "$" . number_format($row['gdp_per_capita']) . " USD"; ?></p>
    </div>
</div>