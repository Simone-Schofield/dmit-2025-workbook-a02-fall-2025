...
// Because we are using the GET method, rememeber that the user can muck around with the query string. To prevent any weirdness (i.e. Unpredicted errors and behaviours)
...
<p class="text-danger lead mb-5">
    Are you sure that you want to delete <?= urlencode($city_name); ?>?
</p>
