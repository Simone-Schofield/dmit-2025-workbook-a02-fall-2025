...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // While we don't need to has the second password, we will anyway (just to show the different value result in different hashes, and that even the same values result in different hashes).
    $second_hash = password_hash($second_password, PASSWORD_DEFAULT);

    // This compares to the second password (which is in plain text) with the has generated from the first password. This method will return either TRUE (if it's a match) or FALSE (if it's not a match).
  ...
  <body class="container">
    <main class="row justify-content-center my-5">
        <section class="col col-md-10 col-lg-8">
            <h1 class="text-center">How does password encryption work?</h1>
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <p class="form-text">Enter a string, password, or phase you'd like to test.</p>
