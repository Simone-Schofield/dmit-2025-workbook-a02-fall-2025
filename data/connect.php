...
function db_connect() {
    ...
    if (mysqli_connect_errno()) {
        ...
        // There are three places we need to check to make sure we have the correct character encoding: the database, out HTML document, and here in our MySQLi connection handle.
